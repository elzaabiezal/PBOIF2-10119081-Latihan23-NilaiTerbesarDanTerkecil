 ...
 */
package pboif2.pkg10119081.latihan23.nilaiterbesardanterkecil;
 ...
 */
public class PBOIF210119081Latihan23NilaiTerbesarDanTerkecil {
   ...
   public static int min(int min,int nilai[], int n) {
    ...
    public static void main(String[] args) {
        ...
        for(int i=1; i<=n; i++){
            System.out.print("Nilai Mahasiswa ke-" + 1 + " = " +nilai[i]);
        }
        System.out.println("");
